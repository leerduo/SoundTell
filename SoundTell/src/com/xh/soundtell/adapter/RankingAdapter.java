	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			viewHolder.img = (ImageView) convertView
					.findViewById(R.id.ranking_img);
			viewHolder.level = (TextView) convertView
					.findViewById(R.id.ranking_level);
			viewHolder.songName = (TextView) convertView
					.findViewById(R.id.ranking_songname);
			viewHolder.userName = (TextView) convertView
					.findViewById(R.id.ranking_username);
			viewHolder.time = (TextView) convertView
					.findViewById(R.id.ranking_time);
			viewHolder.follow = (TextView) convertView
					.findViewById(R.id.ranking_follow);
			viewHolder.followLayout = (RelativeLayout) convertView
					.findViewById(R.id.ranking_follow_rl);
