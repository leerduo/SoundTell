...
import com.xh.soundtell.ui.pickphoto.ShowAllPhotoActivity;
import com.xh.soundtell.util.BitmapCache;
import com.xh.soundtell.util.BitmapCache.ImageCallback;

/**
 * 这个是显示所有包含图片的文件夹的适配器
 * 
 * @author 陈宝林
 * @version 2015年08月12日 下午15:52:35
 */
public class FolderAdapter extends BaseAdapter {
	...
	private class ImageViewClickListener implements OnClickListener {
		...
		public void onClick(View v) {
			ShowAllPhotoActivity.dataList = (ArrayList<ImageItem>) AlbumActivity.contentList
