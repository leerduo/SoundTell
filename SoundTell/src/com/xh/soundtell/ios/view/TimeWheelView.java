...
import com.xh.soundtell.ios.listener.OnTimeWheelScrollListener;
...
public class TimeWheelView extends View {
	...
	// Wheel Values
	private TimeWheelViewAdapter adapter = null;
	...
	private List<OnTimeWheelScrollListener> scrollingListeners = new LinkedList<OnTimeWheelScrollListener>();
	 ...
	 * @return the adapter
	 */
	public TimeWheelViewAdapter getAdapter() {
		return adapter;
	}
	 ...
	 */
	public void setAdapter(TimeWheelViewAdapter adapter) {
	 ...
	 *            the listener
	 */
	public void removeChangingListener(OnTimeWheelChangedListener listener) {
	 ...
	 *            the listener
	 */
	public void addScrollingListener(OnTimeWheelScrollListener listener) {
	 ...
	 *            the listener
	 */
	public void removeScrollingListener(OnTimeWheelScrollListener listener) {
	...
	protected void notifyScrollingListenersAboutStart() {
		for (OnTimeWheelScrollListener listener : scrollingListeners) {
	...
	private int getMaxTextLength() {
		TimeWheelViewAdapter adapter = getAdapter();
		if (adapter == null) {
			return 0;
		}
